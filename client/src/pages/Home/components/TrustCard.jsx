...
export default function TrustCard({ titre, description, Icon, className }) {
  return (
    <div
      className={`TrustCard_container flex  flex-col  lg:w-[45%] gap-[20px] w-full  md:gap-[42px]  2xl:flex-row justify-center items-center ${className} `}
    >
